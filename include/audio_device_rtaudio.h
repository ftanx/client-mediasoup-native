...
#ifndef AUDIO_DEVICE_AUDIO_DEVICE_RTAUDIO_H_
#define AUDIO_DEVICE_AUDIO_DEVICE_RTAUDIO_H_
...
#include "../thirdparty/webrtc-checkout/src/modules/audio_device/audio_device_generic.h"
#include "../thirdparty/webrtc-checkout/src/modules/audio_device/mac/audio_mixer_manager_mac.h"
#include "../thirdparty/webrtc-checkout/src/rtc_base/critical_section.h"
#include "../thirdparty/webrtc-checkout/src/rtc_base/event.h"
#include "../thirdparty/webrtc-checkout/src/rtc_base/logging.h"
#include "../thirdparty/webrtc-checkout/src/rtc_base/thread_annotations.h"
...
const uint32_t N_DEVICE_CHANNELS = 16;

const int kBufferSizeMs = 1;

const uint32_t ENGINE_REC_BUF_SIZE_IN_SAMPLES = 16;
    //N_REC_SAMPLES_PER_SEC * kBufferSizeMs / 1000;
const uint32_t ENGINE_PLAY_BUF_SIZE_IN_SAMPLES = 16;
...
const uint32_t TIMER_PERIOD_MS = 2 * N_BLOCKS_IO * 1000000;
...
class RtAudioDevice : public AudioDeviceGeneric {
 public:
  RtAudioDevice();
  ~RtAudioDevice();
